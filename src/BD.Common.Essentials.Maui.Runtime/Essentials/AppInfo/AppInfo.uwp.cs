...
class AppInfoImplementation : IAppInfo
{
    ...
    public string PackageName => AppInfoUtils.IsPackagedApp
        ...
        : _launchingAssembly.ThrowIsNull().GetAppInfoValue("PackageName") ?? _launchingAssembly.GetCustomAttribute<AssemblyTitleAttribute>()?.Title ?? string.Empty;
    ...
    internal static string PublisherName => AppInfoUtils.IsPackagedApp
        ...
        : _launchingAssembly.ThrowIsNull().GetAppInfoValue("PublisherName") ?? _launchingAssembly.GetCustomAttribute<AssemblyCompanyAttribute>()?.Company ?? string.Empty;

    public string Name => AppInfoUtils.IsPackagedApp
        ? Package.Current.DisplayName
        : _launchingAssembly.ThrowIsNull().GetAppInfoValue("Name") ?? _launchingAssembly.GetCustomAttribute<AssemblyTitleAttribute>()?.Title ?? string.Empty;

    public Version? Version => AppInfoUtils.IsPackagedApp
        ? Package.Current.Id.Version.ToVersion()
        : _launchingAssembly.ThrowIsNull().GetAppInfoVersionValue("Version") ?? _launchingAssembly.GetName().Version;
