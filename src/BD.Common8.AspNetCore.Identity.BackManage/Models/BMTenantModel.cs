...
/// <summary>
/// <see cref="BMTenant"/> 模型类
/// </summary>
public sealed partial class BMTenantModel : KeyModel<Guid>
{
    /// <inheritdoc cref="BMTenant.Name"/>
    public string Name { get; set; } = "";

    /// <inheritdoc cref="BMTenant.Contact"/>
    public string? Contact { get; set; }

    /// <inheritdoc cref="BMTenant.ContactPhoneNumber"/>
    public string? ContactPhoneNumber { get; set; }

    /// <inheritdoc cref="BMTenant.Address"/>
    public string? Address { get; set; }

    /// <inheritdoc cref="BMTenant.RegisterEmail"/>
    ...
    public static IQueryable<BMTenant> Includes(IQueryable<BMTenant> query)
      => query
        .Include(x => x.OperatorUser)
        .Include(x => x.CreateUser);

    /// <summary>
    /// 表达式用于将 <see cref="BMTenant"/> 转换为 <see cref="BMTenantModel"/>
    /// </summary>
    public static readonly Expression<Func<BMTenant, BMTenantModel>> Expression = x => new()
    {
        Id = x.Id,
...
/// <summary>
/// 添加或编辑 <see cref="BMTenant"/> 租户数据模型基类
/// </summary>
...
public sealed class AddOrEditSysTenantModel : KeyModel<Guid>, IValidatableObject
{
    ...
    /// <inheritdoc cref="BMTenant.UniqueCode"/>
    ...
    /// <inheritdoc cref="BMTenant.RegisterPhoneNumber"/>
    public string? RegisterPhoneNumber { get; set; }

    /// <inheritdoc cref="BMTenant.RegisterEmail"/>
    public string? RegisterEmail { get; set; }

    /// <inheritdoc cref="BMTenant.AuditorId"/>
    public Guid? AuditorId { get; set; }

    /// <inheritdoc cref="BMTenant.Auditor"/>
    public string? Auditor { get; set; }

    /// <inheritdoc cref="BMTenant.AuditTime"/>
    public DateTimeOffset? AuditTime { get; set; }

    /// <inheritdoc cref="BMTenant.AuditStatus"/>
    public SysTenantAuditStatus? AuditStatus { get; set; }

    /// <inheritdoc cref="BMTenant.AuditRemarks"/>
    public string? AuditRemarks { get; set; }

    /// <inheritdoc cref="BMTenant.AuthorizationStartTime"/>
    public DateTimeOffset AuthorizationStartTime { get; set; }

    /// <inheritdoc cref="BMTenant.AuthorizationEndTime"/>
    public DateTimeOffset AuthorizationEndTime { get; set; }

    /// <inheritdoc cref="BMTenant.Disable"/>
    public bool Disable { get; set; }

    /// <inheritdoc cref="BMTenant.Remarks"/>
    public string? Remarks { get; set; }

    /// <inheritdoc cref="BMTenant.IsPlatformAdministrator"/>
...
/// <summary>
/// 提供对实体类 <see cref="BMTenant"/> 的扩展方法
/// </summary>
public static partial class EntitiesExtensions
{
    /// <summary>
    /// 将 <see cref="AddOrEditSysTenantModelBase"/> 对象的属性值赋给 <see cref="BMTenant"/> 对象
    /// </summary>
    public static BMTenant SetValue(
        this BMTenant entity,
...
{
    /// <summary>
    /// 将 <see cref="BMTenantModel"/> 对象的属性值赋给 <see cref="AddOrEditSysTenantModelBase"/> 对象
    /// </summary>
