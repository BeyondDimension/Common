...
namespace Microsoft.Win32
{
    ...
    public sealed class OpenFolderDialog : CommonItemDialog
    {
        ...
        {
            get => GetOption(FOS.ALLOWMULTISELECT);
            set => SetOption(FOS.ALLOWMULTISELECT, value);
        }
        ...
        private const string FileOpenDialog = "DC1C5A9C-E88A-4dde-A5A1-60F82A20AEF7";

        private protected override IFileDialog CreateDialog()
        {
            return (IFileDialog)Activator.CreateInstance(Type.GetTypeFromCLSID(new Guid(FileOpenDialog)));
        }
