...
using HRESULT = MS.Win32.HRESULT;
...
namespace Microsoft.Win32
{
    ...
    public abstract class CommonItemDialog : CommonDialog
    {
        ...
        {
            get => !GetOption(FOS.DONTADDTORECENT);
            set => SetOption(FOS.DONTADDTORECENT, !value);
        }
        ...
        public string DefaultDirectory
        {
            get =>
                ...
                _defaultDirectory == null ? string.Empty : _defaultDirectory;
        ...
        {
            get => !GetOption(FOS.NODEREFERENCELINKS);
            set => SetOption(FOS.NODEREFERENCELINKS, !value);
        }
        ...
        public string InitialDirectory
        {
            get =>
                // Avoid returning a null string - return String.Empty instead.
                _initialDirectory == null ? string.Empty : _initialDirectory;
        ...
        public string RootDirectory
        {
            get =>
                // Avoid returning a null string - return String.Empty instead.
                _rootDirectory == null ? string.Empty : _rootDirectory;
        ...
        {
            get => GetOption(FOS.FORCESHOWHIDDEN);
            set => SetOption(FOS.FORCESHOWHIDDEN, value);
        }
        ...
        {
            get => !GetOption(FOS.NOVALIDATE);
            set => SetOption(FOS.NOVALIDATE, !value);
        }
