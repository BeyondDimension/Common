...
/// <para>https://docs.microsoft.com/zh-cn/xamarin/essentials/file-picker</para>
/// <para>https://github.com/xamarin/Essentials/blob/main/Xamarin.Essentials/FilePicker/FilePicker.shared.cs</para>
/// </summary>
public static partial class FilePicker2
{
    static string AssemblyTrademark => IApplicationVersionService.Instance.AssemblyTrademark;
    ...
    public static async Task<IFileResult?> PickAsync(PickOptions? options = null)
    {
        ...
        catch (Exception e)
        {
            ...
            {
                ToastHelper.Show(ToastIcon.Error, e.Message); // Xamarin.Essentials.PermissionException
                return null;
            }
            else
            {
    ...
    /// <returns>文件拾取结果对象，或当用户取消拾取时为空。</returns>
    /// <exception cref="PlatformNotSupportedException"></exception>
    public static async Task<SaveFileResult?> SaveAsync(PickOptions? options = null)
    {
        try
        {
