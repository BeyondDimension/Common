...
public static partial class IOPath
{
    ...
    // The port of .net core Path.GetRelativePath https://github.com/dotnet/runtime/blob/84b7c2f15ceec32e66b46231614dfcb3e334c6fd/src/libraries/System.Private.CoreLib/src/System/IO/Path.cs#L854
    ...
    internal static class PathInternalNetCore
    {
            ...
            if ((!extendedSyntax || extendedUncSyntax) && path.Length > 0 && IsDirectorySeparator(path[0]))
            {
                ...
                if (extendedUncSyntax || (path.Length > 1 && IsDirectorySeparator(path[1])))
                {
                    ...
                    while (i < path.Length && (!IsDirectorySeparator(path[i]) || --n > 0)) i++;
                     ...
                     path[volumeSeparatorLength - 1] == PathInternalNetCore.VolumeSeparatorChar)
            {
        ...
        {
            return c == PathInternalNetCore.DirectorySeparatorChar || c == PathInternalNetCore.AltDirectorySeparatorChar;
        }
