...
#pragma warning restore SA1114 // Parameter list should follow declaration
    ...
    public static void MoveFile(string sourceFileName, string destFileName, bool overwrite)
    {
        ...
        var moveOpt = overwrite
           ? CsWin32.Storage.FileSystem.MOVE_FILE_FLAGS.MOVEFILE_REPLACE_EXISTING | CsWin32.Storage.FileSystem.MOVE_FILE_FLAGS.MOVEFILE_WRITE_THROUGH
           : CsWin32.Storage.FileSystem.MOVE_FILE_FLAGS.MOVEFILE_WRITE_THROUGH;

        if (!CsWin32.PInvoke.MoveFileEx(sourceFileName, destFileName, moveOpt))
        {
