...
/// <seealso cref="IDangerousGetHandle"/>
[DebuggerDisplay("{handle}")]
public abstract partial class SafeHANDLE : SafeHandleZeroOrMinusOneIsInvalid, IEquatable<SafeHANDLE>, IDangerousGetHandle
{
    ...
    /// <returns>The result of the operator.</returns>
    public static bool operator !=(SafeHANDLE? h1, IDangerousGetHandle? h2) => !(h1 == h2);
    ...
    /// <param name="h2">The second handle.</param>
    /// <returns>The result of the operator.</returns>
    public static bool operator ==(SafeHANDLE? h1, IDangerousGetHandle? h2) => h1?.Equals(h2) ?? h2 is null;
    ...
    {
        IDangerousGetHandle ih => handle.Equals(ih.DangerousGetHandle()),
