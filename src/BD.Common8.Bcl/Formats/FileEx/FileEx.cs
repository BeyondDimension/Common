...
public static partial class FileEx
{
    ...
    /// <summary>
    /// 压缩的 Debian 软件包扩展名（tar格式）：.deb.tar
    /// </summary>
    public const string DEB_TAR = ".deb.tar";

    /// <summary>
    /// 压缩的 Debian 软件包扩展名（tar.xz格式）：.deb.tar.xz
    /// </summary>
