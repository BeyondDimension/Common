...
public sealed class ModelValidatorImpl : IModelValidator
{
    static readonly MethodInfo matchValidateMethod = typeof(ModelValidatorImpl).GetMethod(nameof(MatchValidate), BindingFlags.NonPublic | BindingFlags.Static)!;
