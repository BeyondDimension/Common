...
{
    static int rating = -1;
    static readonly Lazy<bool> mIsEmulator = new(GetIsEmulator, true);
...
#pragma warning disable SA1300 // Element should begin with upper-case letter
        ...
        static bool _()
        {
            ...
            if (rating < 0)
            {
                var PRODUCT = global::Android.OS.Build.Product;
                if (PRODUCT == null ||
                ...
                var BRAND = global::Android.OS.Build.Brand;
                if (BRAND == null ||
                ...
                var HARDWARE = global::Android.OS.Build.Hardware;
                if (HARDWARE == null ||
                ...
                var FINGERPRINT = global::Android.OS.Build.Fingerprint;
                if (FINGERPRINT == null ||
...
#pragma warning restore SA1312 // Variable names should begin with lower-case letter
    ...
    static bool GetIsChromeOS()
    {
        ...
        try
        {
            var value = global::Android.App.Application.Context.PackageManager?.HasSystemFeature("org.chromium.arc.device_management");
            return value ?? false;
        }
        catch
        {
    ...
    static readonly Lazy<bool> mIsChromeOS = new(GetIsChromeOS, true);
}
#endif