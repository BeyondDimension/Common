...
using SSR = BD.Common.Models.SmsSender.SendSmsResult<BD.Common.Models.SmsSender.Channels.NetEaseCloud.SendSmsNetEaseCloudResult>;
using SSRR = BD.Common.Models.SmsSender.Channels.NetEaseCloud.SendSmsNetEaseCloudResult;
...
public class SmsSenderProvider : SmsSenderBase, ISmsSender
{
       ...
       where TResult : NetEaseCloudResult<TResult>
    {
        ...
        {
            jsonObject = await ReadFromJsonAsync<TResult>(response.Content, cancellationToken);
