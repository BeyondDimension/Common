...
public partial class ObsClient
{
    ...
    {
        return EndDoRequest<GetApiVersionRequest, GetApiVersionResponse>(BeginDoRequest(request, null, null));
    }
    ...
    {
        HttpContext context = BeforeRequest(request, doValidateDelegate, true);
        try
        {
            HttpObsAsyncResult result = httpClient.BeginPerformRequest(PrepareHttpRequest(request, context), context, callback, state);
        ...
        where K : ObsWebServiceResponse
    {
        ...
        HttpObsAsyncResult? result = ar as HttpObsAsyncResult ?? throw new ObsException(Constants.NullRequestMessage, ErrorType.Sender, Constants.NullRequest, "");
